...
\begin{titlepage} 
    ...
    \begin{center}
        {\fontsize{20}{28}\fontfamily{phv}\selectfont\bfseries X-ray Bursts as a Tool to Constrain the Equation of State of the Ultra-Dense Matter Inside Neutron Stars}
