...
Detailed microphysics of such matter is still unknown and this is reflected in a large uncertainty in the actual size of the star that is still \refe{poorly constrained.}
...
In the laboratories on Earth we can probe the matter somewhere close to $10^{14} \gcm$, after which the densities become\refedel{s} too great for us to manipulate.%
