...
\refe{The} overview of the EoS for the full range of densities relevant to neutron stars is shown in \fig{fig:eos}.
...
\Mu = \frac{\bra{Z}}{\bra{A}},
\ee
where $\bra{Z}$ is the mean charge number of the atomic nuclei (for \refe{a} one-component plasma it is simply $Z$), and $\bra{A}$ is the average number of nucleons bound by one nucleus.
