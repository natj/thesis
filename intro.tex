...
\footnoteB{For the pedantic ones, we specify that a supernova is actually an implosion followed by a subsequent explosion.}
...
Anticipation by theorist before the second World War. \sfcite{Landau32}
...
Later published in Nature 1968 by Hewish. \sfcite{Hewish68}


\subsection{History of degenerate electron gas and Chandrasekhar limit}
electrons as fermions\sfcite{Dirac25}
electron deg. pressure \sfcite{Fowler26}
elecs must be relativistic \sfcite{Anderson29}
equation of state for uniform density \sfcite{Stoner30}
Similar independent study by Landau \sfcite{Landau32}
full equation of state of degenerate electron gas unaware of Fowler \sfcite{Frenkel28} \sfcite{Yakovlev94}

Finally put together by Chandrasekhar \sfcite{Cha31} work done 5 years before Stoner.
