...
\chapterimage[width=12.8cm]{wordcloud/chap1b.png}
...
\footnote{
    The mass of the atom, $m_{\mathrm{atom}} = \mproton + \me$, is approximated (to an excellent accuracy) by considering the nuclei alone as the electron mass $\me \approx \Ten{9.11}{-28} \g$ is negligible in comparison to the proton mass.
}
...
One final characteristic we can try to estimate is the magnetic field. %\mnote{$B$-field}
