...
Interestingly, the combination of these two fit parameters then yield a distance-independent quantity, physically corresponding to the Eddington temperature of the source at infinity, and given as\red{check}
\be
T_{\mathrm{Edd},\infty} 
%= 9.81 
= \Ten{1.14}{8}
...
In short, these include \textit{I}) theoretical work on the models, \textit{II}) understanding the astrophysical environment better, and \textit{III}) applying the models and the new insights to astronomical observations.
...
\subsubsection*{Paper VII.: Equation of state constraints for the cold dense matter inside neutron stars using the cooling tail method}
...
\subsubsection*{Paper VIII.: Detection of burning ashes from thermonuclear X-ray bursts}
...
\subsubsection*{Paper XI.: Atmosphere model fits of thermonuclear X-ray burst cooling tail spectra: new neutron star mass and radius constraints using Bayesian hierarchical modeling}
